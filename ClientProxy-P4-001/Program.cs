    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ServiceReference1.MatematikaClient();
                        ...
                        ServiceReference1.IMatematikaKoordinat a =new
            ServiceReference1.IMatematikaKoordinat();
                        ServiceReference1.IMatematikaKoordinat b = new
            ServiceReference1.IMatematikaKoordinat();
